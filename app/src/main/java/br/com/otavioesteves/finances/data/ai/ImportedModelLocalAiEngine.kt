 ...
 * (Fase 2a — docs/PLANO_MOTOR_IA_LOCAL.md, seção 2.3). There is no real
 * inference yet: [warmUp] is a format/size sanity check on the bundle, not a
 * load of an actual LiteRT-LM runtime — that arrives in Fase 3, at which
 * point this class's storage/verification logic is reused by the real engine.
 */
